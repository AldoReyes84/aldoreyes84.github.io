...
-----------------------------------------------------------------------------------------------
## [Work Experience](https://aldoreyes84.github.io/working_experience/en/)

------------------------------------------------------------------------------------------------
## [About me](https://aldoreyes84.github.io/about_me/en/)

--------------------------------------------------------------------------------------------------
## Projects

##### 1.- <img src="{{ 'assets/icons/powerbi.png' | relative_url }}" alt="power bi icon" width="24" height="17">[ Contoso Sales Power BI Dashboard](https://aldoreyes84.github.io/contoso_pbi_dashboard/en/)

##### 2.- 🧠[ AdventureWorks2022 Data Analysis](https://aldoreyes84.github.io/adworks_data_analysis/en/)

##### 3.- <img src="{{ 'assets/icons/microsoft-sql-server-logo.png' | relative_url}}" alt="ssis icon" width="24" height="19">[ ETL SSIS Integration Package with Python Faker Files](https://aldoreyes84.github.io/etl_ssis_integration_package/en/)
